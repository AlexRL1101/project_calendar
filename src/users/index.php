    ...
    <div class="container">
        ...
        <div class="main-wrapper">
            ...
            <table FRAME="void" align="center" RULES="rows" width="75%" height="200px" bordercolor="#8C00FF">
                <tr>
                    <th style="color:#FFFFFF" bgcolor="#2079FF" class="text-center" width="41%" height="15%">Nombre´s
                    </th>
                ...
                <tr>
                    ...
                    <td><a class="btn-sm btn-primary" href="editar.php?id=<?php echo $row->id; ?>"><i
                                class="fa fa-pencil fa-lg" aria-hidden="true"></i></a>
                        <a class="btn-sm btn-danger" href="borrar.php?id=<?php echo $row->id;?>"><i
